...
public class Scene_Drop extends Scene_Base {
	...
	private Scene_Base old_scene;

	public Scene_Drop(RPGGame f, Scene_Base s) throws IOException,
			FontFormatException {
		super(f);
